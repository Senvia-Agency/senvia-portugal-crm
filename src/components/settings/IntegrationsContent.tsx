...
function VendusForm({ chavesGuardadas, vendusApiKey, setVendusApiKey, showVendusApiKey, setShowVendusApiKey, vendusOptionsLoaded, vendusRegisterReady, vendusOptionsLoading, handleLoadVendusOptions, handleSaveVendus, updateOrganizationIsPending }: IntegrationsContentProps) {
  return (
    <>
      ...
      {vendusOptionsLoaded && (vendusRegisterReady
        ? <p className="text-xs text-green-600">Chave validada e caixa em modo Normal. Podes guardar a integração.</p>
        : <p className="text-xs text-amber-700">Chave validada, mas a emissão real ainda não está pronta. Na Vendus, abre Configuração → Definições → Lojas e Caixas e muda a caixa para o modo Normal. Recomenda-se uma caixa do tipo API.</p>)}
